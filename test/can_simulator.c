...
int send_obd_message(int s, int service) {
	int length_list[] = {2, 3, 4, 5, 6, 7, 8};
	int info[] = {0xd8, 0x81, 0xda, 0x4b, 0xa4, 0x40, 0x1a, 0x31, 0x61, 0x5c, 0xc6, 0xf8, 0xcd, 0x01, 0x51, 0x9a, 0x02, 0x61, 0x92, 0x43, 0xb4, 0x1a, 0xc0, 0xab, 0xa5, 0xf8, 0x24, 0x55, 0x5d, 0x29, 0x12, 0xae, 0x96, 0x95, 0x9b, 0x58, 0x0c, 0x76, 0x9d, 0x78, 0xf4, 0x17, 0x37, 0xa2, 0xc8, 0xff, 0xc8, 0xb9, 0xd4, 0xd7, 0xb0, 0xa1, 0xb1, 0x64, 0xf0, 0xb4, 0xa4, 0xd9, 0xcd, 0x38, 0xf5, 0x06, 0xa8, 0x65, 0x32, 0xe1, 0x7c, 0xae, 0x72, 0x88, 0x77, 0x35, 0x5b, 0x15, 0x09, 0x78, 0x09, 0x39, 0x2a, 0xf6, 0x79, 0x22, 0x7a, 0x60, 0x07, 0x1f, 0x80, 0x8d, 0x29, 0xe8, 0xe5, 0xef, 0x4c, 0x25, 0x2b, 0xdd, 0xb9, 0x1d, 0x0e, 0x13};
			...
			if (i == 1) {
				switch (service) {
					case 1: // Service 01
						...
						frame.data[i] = SERVICE_1;
						break;
					case 2: // Service 02
						printf("Respond service2");
						frame.data[i] = SERVICE_2;
						break;
					case 3: // Service 03
						printf("Respond service3");
						frame.data[i] = SERVICE_3;
						break;
					case 7: // Service 07
						printf("Respond service7");
						frame.data[i] = SERVICE_7;
						break;
					default:
						break;
				}
